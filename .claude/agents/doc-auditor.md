...
> 3. `DEPLOYMENT.md` § Service Runbooks — Add entry: "Restart auth-service: `kubectl rollout restart deployment/auth-service -n apps`"

Example of a bad item (too vague):
> 3. Update DEPLOYMENT.md with the new service
